...
let wordList = [
    ...
    { word: '国家社会主義日本同労社党', furigana: 'こっかしゃきしゅぎにほんどうろうしゃとう' },
    ...
    { word: '今タイプミスしたよねｗ雑魚乙ｗｗｗｗｗｗｗｗ君向いてないよ', furigana: 'いまたいぷみすしたよねｗざこおつｗｗｗｗｗｗｗｗきみむいてないよ' },
    { word: '焦ると間違えますよ！', furigana: 'あせるとまちがえますよ！' },
    { word: '焦ろ間違えろ！', furigana: 'あせろまちがえろ！' },
    { word: 'パイソンがおっぱいそん！', furigana: 'ぱいそんがおっぱいそん！' },
    { word: '白い結婚を求め、離縁を求められた妻は、既に家に居なかった。', furigana: 'しろいけっこんをもとめ、りこんをもとめられたつまは、すでにいえにいなかった。' },
    { word: '左遷錬金術師の辺境暮らし　～元エリートは二度目の人生も失敗したので辺境でのんびりとやり直すことにしました～', furigana: 'させんれんきんじゅつしのへんきょうぐらし ～もとえりーとはにどめのじんせいもしっぱいしたのでへんきょうでのんびりとやりなおすことにしました～' },
];
