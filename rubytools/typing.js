...
let wordList = [
    ...
    { word: 'PAさんのピアスはまさしく不良な風貌をかもしだしてるが、ただの美人だ', furigana: 'PAさんのぴあすはまさしくふりょうなふうぼうをかもしだしてるが、ただのびじんだ' },
    { word: 'ぼっちちゃんの胸はとても大きいが、それを超える奇行が多いため恋愛感情がわかない', furigana: 'ぼっちちゃんのむねはとてもおおきいが、それをこえるきこうがおおいためれんあいかんじょうがわかない' },
    { word: '初音ミクのネギを100円で買ったが、実は八百屋で買ったねぎの値段は90円だった', furigana: 'はつねみくのねぎを100えんでかったが、じつはやおやでかったねぎのねだんは90えんだった' },
    { word: '喜多ちゃんは陽キャのように見えるが、実は空気を読んで合わせているのだ', furigana: 'きたちゃんはようきゃのようにみえるが、じつはくうきをよんであわせているのだ' },
    { word: '庭ににわちょりがいると思ったら、ただの鶏だった', furigana: 'にわににわちょりがいるとおもったら、ただのにわとりだった' },
    { word: '重音テトは今は大人気ボカロキャラだが、当初は釣り用の架空キャラだった', furigana: 'かさねてとはいまはだいにんきぼかろきゃらだが、とうしょはつりようのかくうきゃらだった' },
    { word: 'ねこは実は夜行性だと思いがちだが、実は薄明薄暮性', furigana: 'ねこはじつはやこうせいだとおもいがちだが、じつははくめいはくぼせい' },
    { word: '西瓜は現在はおいしい果物だが、昔はそこまでうまくもないし過食部分も少なかった', furigana: 'すいかはげんざいはおいしいくだものだが、むかしはそこまでうまくもないしかしょくぶぶんもすくなかった' },
    { word: 'ルナークライアントはPVP専用クライアントだが、当初はハッククライアントにする予定だった説がある', furigana: 'るなーくらいあんとはPVPせんようくらいあんとだが、とうしょははっくくらいあんとにするよていだったせつがある' },
];
